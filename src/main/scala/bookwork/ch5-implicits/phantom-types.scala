// src/main/scala/bookwork/ch5-implicits/phantom-types.scala

// A workflow for payroll calculations.

package bookwork.implicits.payroll

sealed trait PreTaxDeductions
sealed trait PostTaxDeductions
sealed trait Final

// For simplicity, use Fload for money. Not recommended...
case class Employee(
  name: String,
  annualSalary: Float,
...
object Payroll {
  ...
  def minusFinalDeductions(pay: Pay[PostTaxDeductions]): Pay[PostTaxDeductions] = {
